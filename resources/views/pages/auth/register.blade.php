...
<head>
    ...
    <title>Register|Inscription</title>
</head>
                                                {{-- LIEN FONT AWESOME --}}
              ...
              <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mb-3 card">
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="mt-3 row g-3 needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-validation">
                              <span class="input-group-text" id="inputGroupPrepend"><i class="bi bi-chat-left-text"></i></i></span>
                      ...
                      <div class="col-12">
                        ...
                        <p class="m-0 text-center text-secondary">J'ai deja un compte&#x1F60E; <a href="{{ route('login') }}" class="link-primary text-decoration-none">Se connecter</a></p>

                      </div>


                      <div class="col-12">
                        <button class="bg-orange-600 hover:bg-orange-400 btn btn-sm w-100 text-cyan-50 hover:text-cyan-100" type="submit">inscription</button>
                      </div>
                      <div class="col-12">
