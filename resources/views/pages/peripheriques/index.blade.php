        ...
        <table id="tableperipherique" class="table datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $peripherique->typePeripherique->libelle_type ?? 'N/A' }}</td>
                    <td>{{ $peripherique->etat_peripherique }}</td>
                    <td>

                    @if($peripherique->etat_peripherique === 'Réformé')
                        <span class="btn btn-secondary btn-sm disabled">Visualiser</span>
                        <span class="btn btn-secondary btn-sm disabled">Éditer</span>
                        <span class="btn btn-secondary btn-sm disabled">Supprimer</span>
                    @else
